...
class LiongTahu extends StatefulWidget {
  const LiongTahu({super.key});

  @override
  State<LiongTahu> createState() => _LiongTahuState();
}

class _LiongTahuState extends State<LiongTahu> {
  int jlh = 0 ;
